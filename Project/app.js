...
function register(){
    ...
    if(nameInput!= "" && ageInput!= "" && genderInput!="" && breedInput!= "" && serviceInput!="" && ownerNameInput!= "" &&contactPhoneInput!= ""){
    //step2:
    ...
    var alertElement = document.getElementById("success");
        alertElement.classList.remove("hide");
        setTimeout(function(){
            alertElement.classList.add("hide");
        },3000)
    }else{
        var alertElement = document.getElementById("retry");
        alertElement.classList.remove("hide");
        setTimeout(function(){
            alertElement.classList.add("hide");
        },3000)
...
function table(){
    ...
    tmp+=`
        <tr id="${salon.pets[i].id}">
            ...
            <td><button "type="button" class="btn btn-danger" onclick="deletePet(${salon.pets[i].id});">Delete</button></td>
        </tr>`;    
        }
